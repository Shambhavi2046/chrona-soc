...
from app.api.v1 import hunting, reports, soar, analytics, threat_intel
...
api_router.include_router(threat_intel.router, prefix="/threat-intel", tags=["threat-intel"], dependencies=protected_dependencies)
