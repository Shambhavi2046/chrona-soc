...
export default function ComplianceDashboard() {
  return (
    <div className="glass-card border border-soc-border rounded-xl p-6 h-full flex flex-col justify-center">
      <h3 className="text-sm font-semibold text-soc-text-secondary uppercase tracking-wider mb-6 text-center">Overall Compliance Posture</h3>
      ...
      <div className="flex justify-center items-center mb-8">
        <div className="relative w-48 h-48 flex items-center justify-center">
          ...
          <div className="absolute flex flex-col items-center justify-center">
            <span className="text-4xl font-bold text-soc-text-primary">89%</span>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
          ...
          <span className="text-lg font-bold text-soc-text-primary">644</span>
        </div>
        <div className="flex items-center justify-between p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
          ...
          <span className="text-lg font-bold text-soc-text-primary">35</span>
        </div>
        <div className="flex items-center justify-between p-3 bg-soc-bg border border-soc-border rounded-lg">
          <div className="flex items-center gap-3">
            <Shield className="w-5 h-5 text-soc-text-secondary" />
            <span className="text-sm font-medium text-soc-text-secondary">Pending Review</span>
          </div>
          <span className="text-lg font-bold text-soc-text-primary">12</span>
        </div>
      </div>
    </div>
  );
