    ...
    <div className="glass-card border border-soc-border rounded-xl p-6 animate-in fade-in duration-300 space-y-10">
      ...
      <section>
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-400 mt-1">Manage configuration exports and system restoration points.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="p-5 bg-soc-bg border border-soc-border rounded-xl">
            ...
            <h3 className="text-md font-bold text-white mb-2">Export Configuration</h3>
            <p className="text-xs text-gray-400 mb-4 h-12">Download a JSON snapshot of your dashboards, alert rules, and RBAC settings.</p>
          ...
          <div className="p-5 bg-soc-bg border border-soc-border rounded-xl relative overflow-hidden group">
            ...
            <h3 className="text-md font-bold text-white mb-2 relative z-10">Restore Configuration</h3>
            <p className="text-xs text-gray-400 mb-4 h-12 relative z-10">Upload a JSON snapshot. <strong className="text-red-400">Warning:</strong> This will overwrite current settings.</p>
            <button className="w-full py-2 bg-soc-card hover:bg-soc-border border border-soc-border rounded-lg text-sm font-medium text-white transition-colors relative z-10">
              Upload Backup File
            </button>
          </div>
        </div>
      ...
      <section>
        <h3 className="text-md font-bold text-white mb-4">Automated Backups</h3>
        <div className="p-4 bg-soc-bg border border-soc-border rounded-lg flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-medium text-white flex items-center gap-2">Database Snapshot <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" /></h4>
              <p className="text-xs text-gray-500 mt-1">Full system backup completed successfully.</p>
            </div>
          </div>
          <div className="flex flex-col md:items-end gap-1">
            <span className="text-xs text-gray-400">Last Backup: Today at 03:00 AM</span>
            <span className="text-xs text-gray-400">Size: 4.2 GB</span>
            <button className="text-xs text-soc-accent hover:text-white transition-colors flex items-center gap-1 mt-1">
