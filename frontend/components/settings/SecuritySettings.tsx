    ...
    <div className="glass-card border border-soc-border rounded-xl p-6 animate-in fade-in duration-300 space-y-10">
      ...
      <section>
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-400 mt-1">Manage your password, 2FA, and authentication methods.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-soc-bg border border-soc-border rounded-lg flex items-center justify-between">
            ...
            <button className="px-3 py-1.5 bg-soc-card hover:bg-soc-border border border-soc-border rounded text-xs font-medium text-white transition-colors">Update</button>
          </div>
          ...
          <div className="p-4 bg-soc-bg border border-soc-border rounded-lg flex items-center justify-between">
            ...
            <button className="px-3 py-1.5 bg-soc-card hover:bg-soc-border border border-soc-border rounded text-xs font-medium text-white transition-colors">Configure</button>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h3 className="text-md font-bold text-white">Active Sessions</h3>
            ...
            <div key={device.id} className="p-4 bg-soc-bg border border-soc-border rounded-lg flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="p-2 bg-soc-card rounded-lg">
                  {device.name.includes("iPhone") ? <Smartphone className="w-5 h-5 text-gray-400" /> : <Laptop className="w-5 h-5 text-gray-400" />}
                </div>
                <div>
              ...
              <div className="flex flex-col items-end gap-2">
                <span className="text-[10px] text-gray-500 flex items-center"><Clock className="w-3 h-3 mr-1" /> {device.lastActive}</span>
                {!device.isCurrent && (
      ...
      <section>
        <div className="mb-6">
          <h3 className="text-md font-bold text-white">Developer Settings</h3>
        </div>
        <div className="p-4 bg-soc-bg border border-soc-border rounded-lg flex items-center justify-between">
          <div>
            <h4 className="text-sm font-medium text-white">Personal Access Tokens</h4>
            <p className="text-xs text-gray-500 mt-1">Generate tokens for API access. (2 Active)</p>
          </div>
