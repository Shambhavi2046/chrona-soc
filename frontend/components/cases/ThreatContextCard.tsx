  ...
  return (
    <div className="glass-card rounded-xl p-6 h-full flex flex-col">
      <div className="flex items-center mb-6">
        ...
        <h3 className="text-lg font-semibold text-soc-text-primary">Threat Context</h3>
      </div>
      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between p-3 bg-soc-bg border border-soc-border rounded-lg hover:border-soc-accent/50 transition-colors group">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] text-soc-text-muted uppercase tracking-wider font-semibold block">Threat Actor</span>
              <span className="text-sm font-bold text-soc-text-primary">{threat.actor}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between p-3 bg-soc-bg border border-soc-border rounded-lg hover:border-soc-accent/50 transition-colors group">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] text-soc-text-muted uppercase tracking-wider font-semibold block">Malware Family</span>
              <span className="text-sm font-bold text-soc-text-primary">{threat.malware_family}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-soc-bg border border-soc-border rounded p-3 flex flex-col">
            <div className="flex items-center gap-1 mb-1">
              ...
              <span className="text-[10px] text-soc-text-muted uppercase font-mono">Related IOCs</span>
            </div>
            <span className="text-sm font-mono font-bold text-soc-text-primary">{threat.ioc_count}</span>
          </div>
          
          <div className="bg-soc-bg border border-soc-border rounded p-3 flex flex-col">
            <div className="flex items-center gap-1 mb-1">
              <ShieldAlert className="w-3 h-3 text-soc-danger" />
              <span className="text-[10px] text-soc-text-muted uppercase font-mono">Reputation</span>
            </div>
        ...
        <div className="bg-soc-bg border border-soc-border rounded p-3 flex flex-col">
          <div className="flex items-center gap-1 mb-1">
            <Database className="w-3 h-3 text-soc-text-secondary" />
            <span className="text-[10px] text-soc-text-muted uppercase font-mono">Feed Source</span>
          </div>
          <span className="text-xs font-mono text-soc-text-secondary">{threat.feed_source}</span>
        </div>

        {threat.cves.length > 0 && (
          <div className="mt-2">
            <span className="text-[10px] text-soc-text-muted uppercase tracking-wider font-semibold block mb-2">Known CVEs</span>
