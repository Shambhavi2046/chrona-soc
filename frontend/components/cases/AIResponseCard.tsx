  ...
  return (
    <div className="glass-card rounded-xl overflow-hidden flex flex-col h-full border border-soc-border">
      <div className="p-6 border-b border-soc-border bg-soc-bg/30">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h3 className="text-lg font-semibold text-soc-text-primary">AI Analyst Summary</h3>
          </div>
      ...
      <div className="p-6 flex-1 flex flex-col gap-6">
        <div>
          <p className="text-sm text-soc-text-secondary leading-relaxed">
        ...
        {recommendations.length > 0 && (
          <div>
            <h4 className="text-sm font-semibold text-soc-text-primary flex items-center mb-3">
                ...
                <div key={idx} className="flex flex-col p-4 bg-soc-bg border border-soc-border rounded-lg group hover:border-soc-accent/50 transition-colors">
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-soc-text-primary">{rec.action}</span>
                    </div>
                  ...
                  <div className="flex items-center gap-4 text-[10px] text-soc-text-muted font-mono pl-4">
                    ...
                    <span>IMPACT: <span className="text-soc-text-secondary">{rec.impact}</span></span>
