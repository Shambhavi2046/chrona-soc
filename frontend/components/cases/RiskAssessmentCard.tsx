  ...
  return (
    <div className="glass-card rounded-xl p-6 h-full flex flex-col">
      <div className="flex items-center mb-6">
        ...
        <h3 className="text-lg font-semibold text-soc-text-primary">Risk Assessment</h3>
      </div>
      ...
      <div className="flex-1 grid grid-cols-2 gap-4">
        ...
        <div className="p-4 bg-soc-bg border border-soc-border rounded-lg flex flex-col justify-center items-center text-center">
          ...
          <span className="text-[10px] text-soc-text-muted uppercase tracking-wider font-semibold mb-1">Overall Risk</span>
        ...
        <div className="p-4 bg-soc-bg border border-soc-border rounded-lg flex flex-col justify-center items-center text-center">
          ...
          <span className="text-[10px] text-soc-text-muted uppercase tracking-wider font-semibold mb-1">Likelihood</span>
        ...
        <div className="col-span-2 grid grid-cols-3 gap-2 mt-2">
          <div className="bg-soc-card border border-soc-border/50 rounded flex flex-col p-3">
            <Target className="w-4 h-4 text-soc-text-secondary mb-1" />
            <span className="text-[9px] text-soc-text-muted uppercase font-mono">Asset Exposure</span>
            <span className={`text-xs font-bold ${getMetricColor(risk.asset_exposure)}`}>{risk.asset_exposure}</span>
          </div>
          <div className="bg-soc-card border border-soc-border/50 rounded flex flex-col p-3">
            <Shield className="w-4 h-4 text-soc-text-secondary mb-1" />
            <span className="text-[9px] text-soc-text-muted uppercase font-mono">Threat Confidence</span>
            <span className={`text-xs font-bold ${getMetricColor(risk.threat_confidence)}`}>{risk.threat_confidence}</span>
          </div>
          <div className="bg-soc-card border border-soc-border/50 rounded flex flex-col p-3">
            <Crosshair className="w-4 h-4 text-soc-text-secondary mb-1" />
            <span className="text-[9px] text-soc-text-muted uppercase font-mono">Complexity</span>
