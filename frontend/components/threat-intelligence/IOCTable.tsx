      ...
      <div className="p-6 border-b border-soc-border flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="bg-soc-bg border border-soc-border rounded-lg pl-9 pr-4 py-1.5 text-sm text-soc-text-primary focus:outline-none focus:border-soc-accent transition-colors"
          />
        </div>
      </div>
              ...
              iocs.map((ioc) => (
                <tr key={ioc.id} className="hover:bg-soc-card-hover/50 transition-colors group">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="px-2 py-1 bg-soc-bg border border-soc-border rounded text-xs font-medium text-soc-text-secondary">
                      {ioc.type}
                    </span>
                  </td>
                  <td className="px-6 py-4 font-mono text-sm text-soc-text-secondary group-hover:text-soc-text-primary transition-colors">
                    {ioc.value}
                  </td>
                  <td className="px-6 py-4">
                    <div className="font-medium text-soc-text-secondary">{ioc.category}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
